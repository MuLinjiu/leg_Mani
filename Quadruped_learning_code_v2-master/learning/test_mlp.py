...
model_dir = "ray_results_ppo/End2End-1024-22-42/PPO/PPO_DummyQuadrupedEnv_cc2a6_00000_0_2022-10-24_22-42-22"
...
class DummyQuadrupedEnv(gym.Env):
    ...
    def __init__(self, dummy_env_config):
        ...
        self.env = QuadrupedGymEnv(render=True, time_step=0.001, action_repeat=10, obs_hist_len=5)
...
latest = 'checkpoint_000200/checkpoint-200'
