...
# from usc_learning.learning.rllib_helpers.loco_net_tf_lstm import LocomotionNetTF
...
"""
monitor_dir = datetime.now().strftime("PMTG-%m%d%y-%H-%M-%S") + '/'
...
class DummyQuadrupedEnv(gym.Env):
    ...
    def __init__(self, env_config):
        self.env = QuadrupedGymEnv(time_step=0.001, action_repeat=20, obs_hist_len=3)
...
model = {"fcnet_hiddens": [256, 128], "fcnet_activation": "tanh", "vf_share_layers": True}
