...
"""
monitor_dir = datetime.now().strftime("End2End-%m%d-%H-%M") + '/'
...
class DummyQuadrupedEnv(gym.Env):
    ...
    def __init__(self, env_config):
        self.env = QuadrupedGymEnv(time_step=0.001, action_repeat=10, obs_hist_len=1)
...
model = {"custom_model": "my_model", "lstm_cell_size": 128, "custom_model_config": {}}
